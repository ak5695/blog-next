...
export const translations = {
  zh: {
    ...
    "product.desc.aicodingflow": "AI 效率工具集、工作流指南和自动化技巧，助你 10 倍提升开发效率",
    ...
    "product.desc.rhizo": "极简、强大的 AI 笔记与知识库管理工具",
    "contact.email": "邮箱",
    "contact.x": "X (推特)",
...
感知它，滋养它，并肩同行，骑士般迎向死亡的永夜。`,
  ...
  en: {
    ...
    "product.desc.aicodingflow": "AI tools, workflows, and automation guides to 10x your development efficiency",
    ...
    "product.desc.rhizo": "Minimalist, powerful AI-powered note-taking and knowledge base tool",
